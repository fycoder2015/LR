...
<div class="container">
    ...
    <li><a href="/admin.php?m=Admin&c=post&a=index"><i class="fa fa-edit"></i> 客户管理</a></li>
    <li><a href="/admin.php?m=Admin&c=page&a=index"><i class="fa fa-file-text-o"></i> 广告管理</a></li>
    <!-- 
    <li><a href="/admin.php?m=Admin&c=index&a=index"><i class="fa fa-dashboard"></i> <strong> 网站管理 <b class="caret"></b></strong></a></li>
    <li><a href="/admin.php?m=Admin&c=category&a=index"><i class="fa fa-reorder"></i> 栏目管理</a></li>
    <li><a href="/admin.php?m=Admin&c=post&a=index"><i class="fa fa-edit"></i> 文章管理</a></li>
    <li><a href="/admin.php?m=Admin&c=page&a=index"><i class="fa fa-file-text-o"></i> 单页管理</a></li>
    <li><a href="/admin.php?m=Admin&c=links&a=index"><i class="fa fa-link"></i> 链接管理</a></li>
    <li><a href="/admin.php?m=Admin&c=setting&a=index"><i class="fa fa-link"></i> 网站设置</a></li>
    <li><a href="/admin.php?m=Admin&c=member&a=index"><i class="fa fa-users"></i> 管理员</a></li>
     -->
</ul>
            </div>
            <div class="col-md-10">
