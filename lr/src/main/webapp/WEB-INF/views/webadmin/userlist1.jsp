          ...
          <table class="table table-hover table-striped">
              ...
              <tbody>
              	<tr>
                    ...
                    <td>登录名</td>
                    <td>注册日期</td>
                    <td><a href="/admin.php?m=Admin&c=category&a=update&id=1">编辑</a> | <a href="/admin.php?m=Admin&c=category&a=delete&id=1" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
                </tr>
