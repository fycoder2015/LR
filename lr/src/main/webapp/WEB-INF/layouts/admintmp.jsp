    		...
    		<div class="row">	
    			<div class="col-md-2" style="background-color: #f3f3f3;">
				    <ul class="nav" style="margin: 10px 0;">
					    ...
					    <li><a href="#"><i class="fa fa-dashboard"></i> <strong> 用户管理 <b class="caret"></b></strong></a></li>
					    ...
					    <li><a href="#"><i class="fa fa-dashboard"></i> <strong> 系统管理 <b class="caret"></b></strong></a></li>
