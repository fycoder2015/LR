...
<div class="jz"  style="height:1100px;">
    ...
    <div class="jzleftDivs" onclick="news(1)"><a style="color: #fff;" href="${ctx}/task/tolisttask">兼职列表</a> </div>
        ...
        <div class="dd">
            ...
            <div class="ddDivfoot">
                ...
                <table id="contentTable" width="100%">
					<thead align="left"><tr><th>Id</th><th>标题</th><th>发布时间</th><th>招聘人数</th><th>状态</th><th></th><th></th></tr></thead>
					<tbody>
							...
							<tr>
								...
								<td>
									<c:if test="${task.jobSts.equals(\"开放\")}">
										<a href="${ctx}/task/delete/${task.id}">
											停用
										</a>
									</c:if>
